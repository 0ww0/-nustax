...
gulp.task('template',function(){
	gulp.src(['src/templates/**/*.+(pug|html)', '!src/templates/include/**/*.+(pug|html)'])
...
gulp.task('favicons', function(){
    gulp.src(folder.srcDest + 'favicons/**/*')
      .pipe(gulp.dest(folder.buildDest + 'favicons/'));
});

gulp.task('iconfont', function(){
  gulp.src([folder.src + 'img/icons/*.svg'])
      .pipe(iconfontCss({
        fontName: fontName,
        targetPath: folder.src + 'scss/components/_fonts.scss',
        fontPath: folder.src + 'fonts/icon/'
      }))
      .pipe(iconfont({
        fontName: fontName,
      ...
      .pipe(gulp.dest(folder.build + 'fonts/icon/'))
});
...
gulp.task('build',['sass','template','images','script','iconfont','fonts','favicons'], function() {
